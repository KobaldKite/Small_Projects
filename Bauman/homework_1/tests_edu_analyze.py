...
class TestGeneral(unittest.TestCase):
    ...
    def test_path_open(self):
        district_list = run_edu_analyze.get_district_list(ACCESS_METHODS[1], self.test_file_path)
    ...
    def test_url_open(self):
        ...
        district_list = run_edu_analyze.get_district_list(ACCESS_METHODS[0], test_file_url)
        self.assertEqual(len(district_list), 9)

    def test_most_common(self):
        district_list = run_edu_analyze.get_district_list(ACCESS_METHODS[1], self.test_file_path)
        common_districts = run_edu_analyze.select_most_common(district_list, 3)
